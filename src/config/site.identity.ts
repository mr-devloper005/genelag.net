export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'genelag',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Genelag',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'genelag.net',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://genelag.net',
